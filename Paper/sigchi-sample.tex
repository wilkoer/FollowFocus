...
\begin{figure}
	...
	\label{fig:BTLE}
\end{figure} 
\item For the Wireless control we use BLE (see Figure \ref{fig:BTLE}) for the reasons mentioned above and because the other two LMU projects use this technology as well.
\begin{figure}
