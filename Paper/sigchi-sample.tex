...
\begin{figure}
	...
	\label{fig:BTLE}
\end{figure} 
\item For the Wireless control we use BLE (see Figure \ref{fig:BTLE}) for the reasons mentioned above and for compatibility reasons with other LMU projects, which use this technology as well.
\begin{figure}
